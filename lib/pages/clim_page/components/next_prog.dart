            ...
            child: BlocBuilder<AcProgBloc, AcProgState>(
              builder: (context, state) {
                ...
                if (state is AcProgSuccess) {
                  ...
                  return const Center(
                      child: Text("An error while loading programations"));
                }
              },
            )));
  }

  Widget _displayAllActiveProg(
      BuildContext context, List<ACProg> progs, bool isLoading) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              progs.isEmpty && !isLoading
                  ? "Aucune PROGRAMMATION prévue".toUpperCase()
...
class NextProg extends StatefulWidget {
  const NextProg({super.key, required this.acProg});
                        ...
                        children: [
                          Text(
                            prog.repetition.isEmpty
                                ...
                                : prog.repetition
                                    .map((day) => day.toShortString())
                                    .join(", "),
                            // Combine les noms des jours en une chaîne
